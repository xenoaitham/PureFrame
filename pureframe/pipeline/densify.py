...
def densify_shot(shot: ShotVerdict, video_path: Path, detector: NudityDetector, settings: ProfileSettings, threshold: float) -> dict[int, list[Detection]]:
    ...
    frames_bgr = extract_frames(video_path, frame_indices, settings.detection_resolution)
