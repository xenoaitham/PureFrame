...
def test_fuse_sexual_act():
    ...
    dets = []
    scene_ctx = ShotContext(
        explicit_act_score=0.5, implied_sex_score=0, kissing_score=0, safe_score=0
    )
    audio_ctx = AudioContext(
        moaning_score=0.5, sexual_audio_score=0.5, music_score=0, speech_score=0
    )
...
def test_fuse_implied_sex():
    ...
    dets = []
    scene_ctx = ShotContext(
        explicit_act_score=0, implied_sex_score=0.6, kissing_score=0, safe_score=0
    )
    audio_ctx = AudioContext(
        moaning_score=0.4, sexual_audio_score=0, music_score=0, speech_score=0
    )
...
def test_fuse_kiss_intense():
    ...
    dets = []
    scene_ctx = ShotContext(
        explicit_act_score=0, implied_sex_score=0, kissing_score=0.6, safe_score=0
    )
    audio_ctx = AudioContext(
        moaning_score=0, sexual_audio_score=0, music_score=0, speech_score=0
    )
...
def test_fuse_safe():
    ...
    dets = []
    scene_ctx = ShotContext(
        explicit_act_score=0, implied_sex_score=0, kissing_score=0, safe_score=0.9
    )
    audio_ctx = AudioContext(
        moaning_score=0, sexual_audio_score=0, music_score=0, speech_score=0
    )
